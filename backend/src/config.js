...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: 'fdcdf1a9355afa3358bf3a28f2f7fa32',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'email scaper <app@flatlogic.app>',
  ...
  project_uuid: '3f8b19b2-5df0-4234-b522-993ad4df39b6',
  flHost:
...
config.pexelsQuery = 'colorful abstract wedding theme';
config.host =
