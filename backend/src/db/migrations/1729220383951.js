module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('emails', 'userId', { transaction });
      ...
      await queryInterface.removeColumn('email_categories', 'categoryId', {
        transaction,
      });

      await queryInterface.removeColumn('email_categories', 'emailId', {
        transaction,
      });
      ...
      await queryInterface.dropTable('email_categories', { transaction });
