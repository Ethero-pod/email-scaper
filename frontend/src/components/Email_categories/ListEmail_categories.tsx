            ...
            >
              ...
              >
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/email_categories/email_categories-edit/?id=${item.id}`}
                  pathView={`/email_categories/email_categories-view/?id=${item.id}`}
                  hasUpdatePermission={hasUpdatePermission}
                />
              </div>
            </CardBox>
          ))}
        {!loading && email_categories.length === 0 && (
...
export default ListEmail_categories;
